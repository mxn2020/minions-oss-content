...
/**
 * @minions-oss-content/cli — CLI for Minions Oss-content
 *
...
import { customTypes } from '@minions-oss-content/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Oss-content'));
        console.log(chalk.dim('Blog post drafts, README updates, social announcements, and demo scripts'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-oss-content/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-oss-content/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-oss-content')}`);
