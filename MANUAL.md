# Manual Setup Steps for Minions Oss-content
...
Go to **GitHub → mxn2020/minions-oss-content → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-oss-content` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-oss-content-web`
- **GitHub repo**: `mxn2020/minions-oss-content`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `oss-content.minions.wtf`

### Documentation
- **Netlify site name**: `minions-oss-content-docs`
- **GitHub repo**: `mxn2020/minions-oss-content`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `oss-content.minions.help`

### Blog
- **Netlify site name**: `minions-oss-content-blog`
- **GitHub repo**: `mxn2020/minions-oss-content`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `oss-content.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `oss-content.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `oss-content.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `oss-content.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-oss-content/sdk`](https://www.npmjs.com/package/@minions-oss-content/sdk)
- CLI: [`@minions-oss-content/cli`](https://www.npmjs.com/package/@minions-oss-content/cli)
...
Your package: [`minions-oss-content`](https://pypi.org/project/minions-oss-content/)
...
| Item | Value |
|------|-------|
| Project | `minions-oss-content` |
| SDK (npm) | `@minions-oss-content/sdk` |
| CLI (npm) | `@minions-oss-content/cli` |
| Python (PyPI) | `minions-oss-content` |
| GitHub | `github.com/mxn2020/minions-oss-content` |
| Docs domain | `oss-content.minions.help` |
| Blog domain | `oss-content.minions.blog` |
| App domain | `oss-content.minions.wtf` |
